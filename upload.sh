...
ssh nas "cd bitwarden && rm -rf web-vault.previous ; mv web-vault web-vault.previous ; ./bitwarden_rs -v ; echo ${WEB_VAULT_FILE} | wget -qi - && tar -zxf bw_web_v*.tar.gz && rm bw_web_v*.tar.gz"
